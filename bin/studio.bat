...
SET _JRE_CANDIDATE=
IF "%JRE%" == "" IF EXIST "%APPDATA%\Google\AndroidStudio2024.3\studio64.exe.jdk" (
  SET /P _JRE_CANDIDATE=<"%APPDATA%\Google\AndroidStudio2024.3\studio64.exe.jdk"
)
IF "%JRE%" == "" (
...
SET IDE_CACHE_DIR=%LOCALAPPDATA%\Google\AndroidStudio2024.3
...
IF "%USER_VM_OPTIONS_FILE%" == "" (
  ...
  ) ELSE IF EXIST "%APPDATA%\Google\AndroidStudio2024.3\studio64.exe.vmoptions" (
    SET "USER_VM_OPTIONS_FILE=%APPDATA%\Google\AndroidStudio2024.3\studio64.exe.vmoptions"
  )
)
